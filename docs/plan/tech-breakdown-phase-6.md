## Tech Breakdown: Phase 6 — Infra: prod + hardening
...
#### P6-IN-1 — Stand up environments/prod with separate GCS state
...
#### P6-IN-2 — Apply prod sizing tfvars (Cloud SQL REGIONAL, deletion protection)

**Type:** Chore · **Owner:** Infra · **Dependencies:** P6-IN-1
...
#### P6-IN-3 — Finalize least-privilege IAM across both envs
...
#### P6-IN-4 — Enable the Cloud Scheduler global cron
...
#### P6-IN-5 — Provision SPA static hosting + deploy

**Type:** Chore · **Owner:** Infra · **Dependencies:** Phase 5 build
...
```
Phase 1 modules → P6-IN-1 → P6-IN-2 / P6-IN-3
P1-IN-7 + P3-BO-5 → P6-IN-4
Phase 5 build → P6-IN-5
```

### Parallel tracks

- P6-IN-2, P6-IN-3 independent after P6-IN-1.
- P6-IN-4 and P6-IN-5 independent of the prod-sizing tasks.

### Open Questions

| # | Question | Blocking tasks | Owner |
|---|----------|----------------|-------|
| 1 | SPA host choice: GCS+CDN vs Firebase Hosting | P6-IN-5 | User/cloud-ops |
| 2 | API edge auth for prod (private Cloud Run vs IAP) before any public exposure | P6-IN-3 | User |
| 3 | Default global cron expression | P6-IN-4 | User/PM |

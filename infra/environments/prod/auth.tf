# --- Identity Platform (backend-proxied auth, P4 wired to prod) ---------------
...
# ponytail: inlined, not a module — one config per project.
...
# tf/tfvars/state — see infra/README.md). Accessor is the api runtime SA only.

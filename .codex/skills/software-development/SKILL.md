...
description: >
  Load before writing, editing, testing, or reviewing Go code. Covers feature
  implementation from architecture docs or ADRs, package structure, Go idioms,
  dependency wiring, tests, PR review, refactoring, and code-smell checks.
  Always read architecture inputs first. Does not make architecture decisions;
  route unclear architecture to software-architecture.
---

...
description: >
  Load before system design work: architecture planning, bounded contexts,
  pattern and tech-stack decisions, C4 diagrams, ADRs, service contracts,
  communication strategies, scalability/reliability trade-offs, and system
  design reviews. Use before implementation for any new system or significant
  feature. Does not generate code; outputs decisions for software-development.
---
